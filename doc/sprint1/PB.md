...
* (new as of sprint 1 end) As a registered user, I want to be able to view a user’s profile by clicking on their picture. 3
* (new as of sprint 1 end) As a registered user, I want to be able to add people to my personal tracker so that I can see their ACS. 13
